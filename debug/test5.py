...
import webbrowser
import threading
import msvcrt  # for Windows, you may need to install msvcrt using `pip install msvcrt`
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while study_preparation_confirmed:
            ...
            if start_or_restart():
                ...
                # If not restarting, exit the inner loop
                break
